...
function Coments({friend}) {
 ...
 const handleOnChange = (e) =>{
  ...
  const handleLikes = (e)=> {
    ...
    e.preventDefault();
    e.currentTarget.classList.toggle("likes")
  ...
  const handlenotLikes = (e) => {

    e.preventDefault();
    e.currentTarget.classList.toggle("unlikes")
  }
        ...
        {comments.map( (item , index) => {
          return(
            <div key={index} className='comment'>
              ...
              <p className='comments-text'>{item.text} <i className={likes ? "fa-regular fa-hand-point-up" : "fa-regular fa-hand-point-up likes"  } onClick={handleLikes}></i> <i className="fa-regular fa-hand-point-down" onClick={handlenotLikes}></i></p>
